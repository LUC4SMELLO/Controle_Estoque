...
def criar_botao_validades(janela_pai):
    ...
    botao_alterar_validades = tk.Button(janela_pai, text="Alterar", font=("Arial", 10, "bold"))
    botao_excluir_validades = tk.Button(janela_pai, text="Excluir", font=("Arial", 10, "bold"))
    botao_consultar_validades = tk.Button(janela_pai, text="Consultar", font=("Arial", 10, "bold"))
