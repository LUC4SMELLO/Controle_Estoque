...
def criar_botao_notificacoes(janela_pai):
    ...
    botao_estoque_inativo_notificacoes = tk.Button(janela_pai, text="Estoque Inativa", font=("Arial", 10, "bold"))
    botao_data_validade_notificacoes = tk.Button(janela_pai, text="Data Validade", font=("Arial", 10, "bold"))
