...
from frontend.janelas.inventario.janela_comparar_estoque import criar_janela_comparar_estoque
...
def criar_botao_inventario(janela_pai):
    ...
    botao_comparar_estoque_inventario = tk.Button(janela_pai, text="Comparar Estoque", width=15, font=("Arial", 10, "bold"), command=criar_janela_comparar_estoque)
