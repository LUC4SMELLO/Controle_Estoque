...
def criar_botao_inventario(janela_pai):
    ...
    botao_digitar_produtos_inventario = tk.Button(janela_pai, text="Digitação Produtos", width=15, font=("Arial", 10, "bold"))
    botao_digitar_doces_inventario = tk.Button(janela_pai, text="Digitação Doces", width=15, font=("Arial", 10, "bold"))
