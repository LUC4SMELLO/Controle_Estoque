...
def criar_janela_cadastrar_produto():
    ...
    label_codigo_produto_cadastrar = tk.Label(janela_cadastrar_produtos, text="Código:", font=LABEL)
    label_codigo_produto_cadastrar.place(x=52, y=10)

    entry_codigo_produto_cadastrar = tk.Entry(janela_cadastrar_produtos, width=7, font=ENTRY)
    entry_codigo_produto_cadastrar.place(x=110, y=10)

    label_descricao_cadastrar = tk.Label(janela_cadastrar_produtos, text="Descrição:", font=LABEL)
    label_descricao_cadastrar.place(x=35, y=40)

    entry_descricao_cadastrar = tk.Entry(janela_cadastrar_produtos, width=50, font=ENTRY)
    entry_descricao_cadastrar.place(x=110, y=40)

    label_produto_ativo_cadastrar = tk.Label(janela_cadastrar_produtos, text="Produto Ativo:", font=LABEL)
    ...
    label_unidade_medida_cadastrar = tk.Label(janela_cadastrar_produtos, text="Unidade:", font=LABEL)
    label_unidade_medida_cadastrar.place(x=45, y=100)

    entry_unidade_medida_cadastrar = ttk.Combobox(janela_cadastrar_produtos, width=25, font=ENTRY)
    entry_unidade_medida_cadastrar['values'] = UNIDADE_MEDIDA_PRODUTOS
    entry_unidade_medida_cadastrar.place(x=110, y=100)

    label_itens_embalagem_produtos_cadastrar = tk.Label(janela_cadastrar_produtos, text="Itens Embalagem:", font=LABEL)
    label_itens_embalagem_produtos_cadastrar.place(x=500, y=100)

    entry_itens_embalagem_produtos_cadastrar = tk.Entry(janela_cadastrar_produtos, font=ENTRY)
    entry_itens_embalagem_produtos_cadastrar.place(x=625, y=100)

    label_subdescricao_cadastrar = tk.Label(janela_cadastrar_produtos, text="Subdescrição:", font=LABEL)
    label_subdescricao_cadastrar.place(x=10, y=150)

    entry_subdescricao_cadastar = tk.Entry(janela_cadastrar_produtos, width=50, font=ENTRY)
    entry_subdescricao_cadastar.place(x=110, y=150)

    label_codigo_barras_cadastrar = tk.Label(janela_cadastrar_produtos, text="Código Barras:", font=LABEL)
    label_codigo_barras_cadastrar.place(x=520, y=150)

    entry_codigo_barras_cadastrar = tk.Entry(janela_cadastrar_produtos, font=ENTRY)
    entry_codigo_barras_cadastrar.place(x=625, y=150)

    label_itens_pallete_cadastrar = tk.Label(janela_cadastrar_produtos, text="Itens Pallete:", font=LABEL)
    label_itens_pallete_cadastrar.place(x=530, y=200)

    entry_itens_pallete_cadastrar = tk.Entry(janela_cadastrar_produtos, width=9, font=ENTRY)
    entry_itens_pallete_cadastrar.place(x=625, y=200)

    label_itens_lastro_cadastrar = tk.Label(janela_cadastrar_produtos, width=9, text="Itens Lastro:", font=LABEL)
    label_itens_lastro_cadastrar.place(x=537, y=230)

    entry_itens_lastro_cadastrar = tk.Entry(janela_cadastrar_produtos, width=9, font=ENTRY)
    entry_itens_lastro_cadastrar.place(x=625, y=230)

    label_grupo_produtos_cadastrar = tk.Label(janela_cadastrar_produtos, text="Grupo:", font=LABEL)
    label_grupo_produtos_cadastrar.place(x=55, y=200)

    entry_grupo_produtos_cadastrar = ttk.Combobox(janela_cadastrar_produtos, width=25, font=ENTRY)
    entry_grupo_produtos_cadastrar["values"] = GRUPO_PRODUTOS
    entry_grupo_produtos_cadastrar.place(x=110, y=200)

    label_categorias_produtos_cadastrar = tk.Label(janela_cadastrar_produtos, text="Categoria:", font=LABEL)
    label_categorias_produtos_cadastrar.place(x=30, y=230)

    entry_categorias_produtos_cadastrar = ttk.Combobox(janela_cadastrar_produtos, width=25, font=ENTRY)
    entry_categorias_produtos_cadastrar["values"] = CATEGORIAS_PRODUTOS
    entry_categorias_produtos_cadastrar.place(x=110, y=230)

    label_marca_produtos_cadastrar = ttk.Label(janela_cadastrar_produtos, text="Marca:", font=LABEL)
    label_marca_produtos_cadastrar.place(x=55, y=260)

    entry_marca_produtos_cadastrar = ttk.Combobox(janela_cadastrar_produtos, width=25, font=ENTRY)
