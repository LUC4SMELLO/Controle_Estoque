...
def criar_janela_consultar_produto():
    ...
    entry_unidade_medida_consultar['values'] = (
    ...
    entry_grupo_produtos_consultar["values"] = (
        "001 - REFRIG",
        "002 - CERVEJA",
        "003 - AGUA",
        "004 - CHAS",
    ...
    entry_categorias_produtos_consultar["values"] = (
        "037 - 200 ML",
        "077 - 220 ML",
        "142 - 250 ML",
        "082 - 290 ML",
    ...
    entry_marca_produtos_consultar["values"] = (
        "001 - 3 MEDALLAS ",
        "001 - FINI",
        "001 - HALLS",
        "001 - JACK DANIEL'S",
